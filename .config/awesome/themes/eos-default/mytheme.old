...
-- Theme wallpaper.
theme.wallpaper                                 = "~/Pictures/eatsleepcode.png"

-- Theme fonts.
theme.font                                      = "Jet Brains Mono 11"
theme.taglist_font                              = "Jet Brains Mono 11"

-- Theme color scheme [Catpuccin]
color_scheme = {
	foreground = "#4C4F69"
}
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
           ...
           -- wibox.container.background(wibox.container.margin(wibox.widget { mailicon, mail and mail.widget, layout = wibox.layout.align.horizontal }, 4, 7), "#343434"),
            ...
            arrow("#7E3EBE", "#7E7EFF"),
            wibox.container.background(wibox.container.margin(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#7E7EFF"),
            arrow("#7E7EFF", "#7E3EBE"),
            wibox.container.background(wibox.container.margin(wibox.widget { volicon, theme.volume.widget, layout = wibox.layout.align.horizontal }, 2, 3), "#7E3EBE"),
            arrow("#7E3EBE", "#7E7EFF"),
