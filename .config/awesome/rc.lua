...
-- {{{ Choosing your theme.
local themeFile = "mytheme.lua"
local themeChosen = themes[1] -- Number is from the above list. Replace with your selected number.
local pathOfTheme = string.format("%s/.config/awesome/themes/%s/%s", os.getenv("HOME"), themeChosen, themeFile)
...
beautiful.init(string.format(gears.filesystem.get_configuration_dir() .. "/themes/%s/%s", themeChosen, themeFile))
-- }}}
